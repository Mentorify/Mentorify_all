        ...
        if (no > 10) {
          ...
          return (
            <>
              ...
              <div className='mt-5'>
                <button className="btn btn-block btn-info mx-2" onClick={incr}>{arr[no - 1][1]}</button>

                <button className="btn btn-block btn-info mx-2" onClick={next}>{arr[no - 1][2]}</button>
              </div>
            </>
          )
        }
